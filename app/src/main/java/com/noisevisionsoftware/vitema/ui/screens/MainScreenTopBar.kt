...
private fun AppTitle(
    ...
    Column(
        ...
        Text(
            text = "Vitema", style = MaterialTheme.typography.headlineMedium.copy(
                fontWeight = FontWeight.Bold
            ), color = MaterialTheme.colorScheme.primary
        )
        Text(
            text = "Twój asystent żywienia",
...
private fun TopBarIconButton(
    ...
    IconButton(
        onClick = onClick, modifier = modifier.pointerHoverIcon(PointerIcon.Hand)
    ) {
        Icon(
            imageVector = icon,
