...
- Data urodzenia
- Płeć
- Pomiary ciała (waga, wzrost, wymiary)
- Notatki do pomiarów
...
1. Pomiary ciała
    ...
    - Dostosowywanie planów dietetycznych

2. Dane osobowe
    - Personalizacja interfejsu
    - Dostosowanie zaleceń dietetycznych do wieku i płci
    - Komunikacja w sprawie aktualizacji i zmian

3. Historia aktywności
    - Optymalizacja funkcji aplikacji
...
Niektóre dane mogą zostać zachowane w formie zanonimizowanej wyłącznie do celów statystycznych.
...
1. W aplikacji:
    ...
    - "Ustawienia" pokazują preferencje i konfigurację

2. Na żądanie:
    - Możliwość pobrania pełnego raportu danych
    - Eksport historii w formacie PDF/CSV
...
2. Prywatność:
    - Możliwość ukrycia szczegółowych pomiarów
    - Kontrola nad udostępnianymi informacjami
    - Opcje prywatności dla poszczególnych funkcji

3. Dane lokalne:
    - Możliwość czyszczenia cache
    - Kontrola nad synchronizacją
